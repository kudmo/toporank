...
This project independently implements the TopoRank algorithm described in the PBScaler paper.

*   **Primary Paper**: S. Zhang et al., "PBScaler: A Bottleneck-Aware Autoscaling Framework for Microservice-Based Applications," in *IEEE Transactions on Services Computing*, vol. 17, no. 2, pp. 604-616, March-April 2024, doi: [10.1109/TSC.2024.xxxxxxx](https://ieeexplore.ieee.org/document/10468626).
*   **Preprint**: [arXiv:2303.14620](https://arxiv.org/html/2303.14620v3) (provides open access to the content).
